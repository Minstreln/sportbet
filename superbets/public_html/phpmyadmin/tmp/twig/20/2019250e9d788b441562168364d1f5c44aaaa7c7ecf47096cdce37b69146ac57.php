...
class __TwigTemplate_d6d47efae73d859cf087bae98782aff9930be2452cfe2e18ec241d01c6306730 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"item\">
    ...
    <input type=\"text\" name=\"hostname\" id=\"pma_hostname\" maxlength=\"";
        ...
        echo "\" value=\"";
        echo twig_escape_filter($this->env, (((isset($context["g_hostname"]) || array_key_exists("g_hostname", $context))) ? (_twig_default_filter(($context["g_hostname"] ?? null), "%")) : ("%")), "html", null, true);
        echo "\" title=\"";
        // line 37
        echo _gettext("Host name");
        echo "\"";
...
";
    ...
    {
        return new Source("", "server/privileges/login_information_fields.twig", "/home/superbets/public_html/phpmyadmin/templates/server/privileges/login_information_fields.twig");
    }
}
