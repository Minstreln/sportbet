                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody class="tabela-class">
                                      ...
                                      <tr v-for="league in leagues" :key="league.id">
                                          <td><b>Futebol</b></td>
                                          <td>{{league.league}}</td>
                                          <td>{{league.created_at | formatDate()}}</td>
                                          <td>    <button class="btn btn-success" title="Bloquear" @click="deleteBlock(league.id)"><i class="fa fa-check"></i></button></td>
...
export default {
    ...
    methods: {
        ...
        loadLigas () {
            this.loading = true;
            axios.get('/admin/list-ligas-bloqueadas')
                    .then((response)=>{
