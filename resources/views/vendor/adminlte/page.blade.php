    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar">
            ...
            <div class="user-panel">
                ...
                @if(auth()->user()->nivel == 'gerente')
                    <i class="fa fa-credit-card"></i>  {{ number_format(auth()->user()->saldo_gerente, 2, ',', '.') }}
        ...
        <footer class="main-footer">
            <div class="pull-right hidden-xs">
                <b>Versão</b> {{config('adminlte.version_system')}}
            </div>
            <strong>Copyright &copy; {{config('adminlte.year_system')}} <a href="http://{{config('adminlte.url_system')}}"> {{config('adminlte.url_system')}}</a> </strong> Todos os direitos reservados.
        </footer>
        <!--End Fotter-->
