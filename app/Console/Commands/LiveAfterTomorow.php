...
class LiveAfterTomorow extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:liveAfter';
    ...
    public function showDepoisAmanha()
    {
        ...
        $aferTomorow = $this->amanha->setTimezone('America/Sao_Paulo')->format('Y-m-d');
